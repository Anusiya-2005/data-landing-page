    ...
    <main>
      <section style={{ padding: '80px 0 0', textAlign: 'center' }}>
        <div className="container">
          ...
          <h1 style={{ fontSize: 'clamp(2.4rem, 4.5vw, 3.5rem)', color: 'var(--navy)', fontWeight: 800, letterSpacing: '-0.04em', maxWidth: '860px', margin: '1rem auto 0' }}>AI Data Services for Banking <span className="gradient-text">&amp; Finance</span></h1>
