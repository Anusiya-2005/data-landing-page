    ...
    <main>
      <section style={{ padding: "60px 0 40px", textAlign: "center", position: "relative" }}>
        <div className="container">
          <h1 style={{ fontSize: "clamp(2.5rem, 4.5vw, 3.5rem)", color: "var(--navy)", fontWeight: 800, letterSpacing: "-0.04em", maxWidth: "900px", margin: "0 auto" }}>Sentiment <span className="gradient-text">Analysis</span></h1>
        ...
        <div className="container">
          ...
          <div className="premium-grid">
            <div className="premium-card">
              ...
              <h3>Data Labeling</h3>
              <p>We apply structured sentiment labels to your raw text at scale across reviews, tickets, social posts, and survey responses using trained annotators, clear guidelines, and quality review at every stage.</p>
            </div>
            <div className="premium-card">
            ...
            <div className="premium-card">
              ...
              <p>Label explicit, first-person opinions and evaluations where the writer directly states a view, preference, or judgment, giving models a clean signal for genuine expressed sentiment.</p>
            </div>
            <div className="premium-card">
