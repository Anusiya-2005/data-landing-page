    ...
    <main className="page" data-route="/solutions/nlp">
      <section className="hero">
        <div className="container hero-grid">
          <div>
            <h1>Turn text and speech into <span className="gradient-text">data that models understand</span></h1>
      ...
      <section className="section alt">
        <div className="container overview">
          <div>
            <h2>Language data for <span className="gradient-text">NLP models</span></h2>
      ...
      <section className="section" id="services" data-anchor="services">
        <div className="container">
          <div className="section-head">
            <h2>NLP <span className="gradient-text">services</span></h2>
            <p>Nine service areas, each with the tasks it includes.</p>
          </div>
          <div className="cards">

            {/* Text Annotation */}
            <Link href="/solutions/nlp/text-annotation" className="svc v1" data-anchor="text-annotation">
            ...
            {/* Text Classification */}
            <Link href="/solutions/nlp/text-classification" className="svc v2" data-anchor="text-classification">
              <div className="svc-head">
            ...
            {/* Video Transcription */}
            <Link href="/solutions/nlp/video-transcription" className="svc v3" data-anchor="video-transcription">
              <div className="svc-head">
            ...
            {/* Relation Extraction */}
            <Link href="/solutions/nlp/relation-extraction" className="svc v1" data-anchor="relation-extraction">
              <div className="svc-head">
            ...
            <Link href="/solutions/nlp/named-entity-recognition" className="svc v2" data-anchor="named-entity-recognition">
              <div className="svc-head">
            ...
            {/* Chatbot Training */}
            <Link href="/solutions/nlp/chatbot-training" className="svc v3" data-anchor="chatbot-training">
              <div className="svc-head">
            ...
            {/* Sentiment Analysis */}
            <Link href="/solutions/nlp/sentiment-analysis" className="svc v1" data-anchor="sentiment-analysis">
              <div className="svc-head">
            ...
            <Link href="/solutions/nlp/feature-classification" className="svc v2" data-anchor="feature-classification">
              <div className="svc-head">
            ...
            <Link href="/solutions/nlp/intent-classification" className="svc v3" data-anchor="intent-classification">
              <div className="svc-head">
