      ...
      <section style={{ padding: '60px 0 40px', textAlign: 'center', position: 'relative' }}>
        <div className="container">
          <h1 style={{ fontSize: 'clamp(2.5rem, 4.5vw, 3.5rem)', color: 'var(--navy)', fontWeight: 800, letterSpacing: '-0.04em', maxWidth: '900px', margin: '0 auto' }}>
            <span className="gradient-text">Reinforcement Learning from Human Feedback</span>
          </h1>
      ...
      <section className="section">
        <div className="container">
          <div style={{ maxWidth: '780px', margin: '0 auto' }}>
            <h2 style={{ color: 'var(--navy)', fontSize: '1.9rem', fontWeight: 800, marginBottom: '1.5rem', letterSpacing: '-0.03em', lineHeight: 1.15 }}>What is RLHF?</h2>
        ...
        <div className="container">
          ...
          <div className="premium-grid">
            ...
            <div className="premium-card">
              ...
              <p>Our experts write and curate high-quality prompt-response pairs tailored to your target domain — legal, medical, customer support, or general-purpose. Each pair is reviewed for accuracy, tone, and instruction-following quality before being added to your SFT dataset.</p>
            </div>
            <div className="premium-card">
